...
- [P] Slice 9 — Plugin Management UI: A settings screen lists installed plugins with name, version, enabled/disabled toggle, and individually revocable permissions. Disabling a plugin removes its panel immediately. → [plan](../slices/2026-04-10-slice-09-plugin-management-ui.md)
